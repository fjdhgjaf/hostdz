...
$_CONFIG['users'] = array(array("<hdusername>", "<hduserpassword>", "admin"));
if($_GET['autologin']){
    session_start();
    $_SESSION['hostdzuser_name'] = $_CONFIG['users']['0']['0'];
    $_SESSION['hostdzuser_passw'] = $_CONFIG['users']['0']['1'];
}
...
$_CONFIG['main_title'] = "HostDzire File Manager";
$_CONFIG['secondary_titles'] = array();
$_CONFIG['show_path'] = true;
$_CONFIG['show_load_time'] = true;
$_CONFIG['time_format'] = "Y-m-d H:i:s";
$_CONFIG['charset'] = "UTF-8";
$_CONFIG['hidden_dirs'] = array("watch","sabnzbd","auto",".session","manual","*","","","","","",);// * working
$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "filemanager.php", "index.php~", ".htaccess", ".htpasswd");
...
$_TRANSLATIONS["al"] = array(
	...
	"total_used_space" => "Memorija e p�rdorur total",
	"free_space" => "Memorija e lir�",
	"password" => "Fjal�kalimi",
	"upload" => "Ngarko skedar�",
	"failed_upload" => "Ngarkimi i skedarit d�shtoi!",
	"failed_move" => "L�vizja e skedarit n� udh�zuesin e sakt� deshtoi!",
	"wrong_password" => "Fjal�kalimi i Gabuar!!",
...
$_TRANSLATIONS["et"] = array(
	...
	"new_dir_failed" => "Kausta loomine eba�nnestus",
	"chmod_dir_failed" => "Kausta �iguste muutmine eba�nnestus",
	"unable_to_read_dir" => "Unable to read directory",
	"location" => "Asukoht",
	"root" => "Peakaust"
);
...
$_TRANSLATIONS["fi"] = array(
	...
	"password" => "Salasana",
	"upload" => "Lis�� tiedosto",
	"failed_upload" => "Tiedoston lis�ys ep�onnistui!",
	"failed_move" => "Tiedoston siirto kansioon ep�onnistui!",
	"wrong_password" => "V��r� salasana",
	"make_directory" => "Uusi kansio",
	"new_dir_failed" => "Uuden kansion luonti ep�onnistui!",
	"chmod_dir_failed" => "Kansion k�ytt�j�oikeuksien muuttaminen ep�onnistui!",
	"unable_to_read_dir" => "Kansion sis�lt�� ei voi lukea.",
	"location" => "Paikka",
	"root" => "Juurihakemisto",
	"log_file_permission_error" => "Ohjelman ei ole sallittu kirjoittaa lokiin.",
	"upload_not_allowed" => "Ohjelman asetukset eiv�t salli tiedoston lis��mist� t�h�n kansioon.",
	"upload_dir_not_writable" => "Kansioon tallentaminen ep�onnistui.",
	"mobile_version" => "Mobiilin�kym�",
	"standard_version" => "Tavallinen n�kym�",
	"page_load_time" => "Sivu ladattu %.2f ms:ssa",
	"wrong_pass" => "V��r� k�ytt�j�tunnus tai salasana",
	"username" => "K�ytt�j�tunnus",
	"log_in" => "Kirjaudu sis��n",
	"log_out" => "Kirjaudu ulos",
	"upload_type_not_allowed" => "T�m�n tiedostotyypin lis��minen on estetty.",
	"del" => "Poista"
);
...
$_TRANSLATIONS["de"] = array(
	...
	"chmod_dir_failed" => "Ver�nderung der Zugriffsrechte des Ordners fehlgeschlagen",
	"unable_to_read_dir" => "Unable to read directory",
	"location" => "Location",
	"root" => "Root"
);
...
$_TRANSLATIONS["hu"] = array(
	"file_name" => "F�jl n�v",
	"size" => "M�ret",
	"last_changed" => "Utols� m�dos�t�s",
	"total_used_space" => "�sszes elfoglalt ter�let",
	"free_space" => "Szabad ter�let",
	"password" => "Jelsz�",
	"upload" => "Felt�lt�s",
	"failed_upload" => "A f�jl felt�lt�se nem siker�lt!",
	"failed_move" => "A f�jl mozgat�sa nem siker�lt!",
	"wrong_password" => "Hib�s jelsz�",
	"make_directory" => "�j mappa",
	"new_dir_failed" => "A mappa l�trehoz�sa nem siker�lt",
	"chmod_dir_failed" => "A mappa jogainak megv�ltoztat�sa nem siker�lt",
	"unable_to_read_dir" => "A mappa nem olvashat�",
	"location" => "Hely",
	"root" => "Gy�k�r",
	"log_file_permission_error" => "A log f�jl �r�sa jogosults�gi okok miatt nem siker�lt.",
	"upload_not_allowed" => "Ebbe a mapp�ba a felt�lt�s nem enged�lyezett.",
	"upload_dir_not_writable" => "A mappa nem �rhat�.",
	"mobile_version" => "Mobil n�zet",
	"standard_version" => "Web n�zet",
	"page_load_time" => "Let�lt�si id? %.2f ms",
	"wrong_pass" => "Rossz felhaszn�l�n�v vagy jelsz�",
	"username" => "Felhaszn�l�n�v",
	"log_in" => "Bel�p�s",
	"upload_type_not_allowed" => "A f�jlt�pus felt�lt�se tiltott."
);
...
$_TRANSLATIONS["pt_BR"] = array(
	...
	"total_used_space" => "Total de espa�o utilizado",
	"free_space" => "Espa�o livre",
	"password" => "Senha",
	"upload" => "Enviar",
	"failed_upload" => "Falha ao enviar o arquivo!",
	"failed_move" => "Falha ao mover o arquivo para o diret�rio correto!",
	"wrong_password" => "Senha errada",
	"make_directory" => "Nova pasta",
	"new_dir_failed" => "Falha ao criar diret�rio",
	"chmod_dir_failed" => "Falha ao mudar os privil�gios do diret�rio",
	"unable_to_read_dir" => "N�o foi poss�vel ler o diret�rio",
	"location" => "Localiza��o",
	"root" => "Ra�z",
	"log_file_permission_error" => "O script n�o tem permiss�o para escrever o arquivo de log.",
	"upload_not_allowed" => "A configura��o do script n�o permite envios neste diret�rio.",
	"upload_dir_not_writable" => "N�o h� permiss�o para escrita neste diret�rio.",
	"mobile_version" => "Vers�o M�vel",
	"standard_version" => "Vers�o Padr�o",
	"page_load_time" => "P�gina carregada em %.2f ms",
	"wrong_pass" => "Nome de usu�rio ou senha errados",
	"username" => "Nome de Usu�rio",
	"log_in" => "Log in",
	"upload_type_not_allowed" => "N�o � permitido envio de arquivos deste tipo."
);
...
$_TRANSLATIONS["sk"] = array(
	"file_name" => "Meno s�boru",
	"size" => "Ve?kos?",
	"last_changed" => "Posledn� zmena",
	"total_used_space" => "Pou.it� miesto celkom",
	"free_space" => "Vo?n� miesto",
	"password" => "Heslo",
	"upload" => "Nahranie s�borov",
	"failed_upload" => "Chyba nahr�vania s�boru!",
	"failed_move" => "Nepodarilo sa presun�? s�bor do vybran�ho adres�ra!",
	"wrong_password" => "Neplatn� heslo!",
	"make_directory" => "Nov� prie?inok",
	"new_dir_failed" => "Nepodarilo sa vytvori? adres�r!",
	"chmod_dir_failed" => "Nepodarilo sa zmeni? pr�va adres�ra!",
	"unable_to_read_dir" => "Nem�.em ?�ta? adres�r",
...
$_TRANSLATIONS["tr"] = array(
	...
	"password" => "Sifre",
	"upload" => "Y�kleyen",
	"failed_upload" => "Hatali dosya y�klemesi!",
...
$_IMAGES["arrow_down"] = "
SMBAPh
+PDwrIsAHvgABeNMLCADATZvAMByH/w/qQplcAYCEAcB0kThLCIAUAEB6jkKmAEBGAYCdmCZTAKAEAGDLY2LjAFAtAGAnf
+bTAICd

+H48PEWhkLnZ2eXk5NhKxEJbYcpXff5nwl/AV/1s
+X48/Pf14L7iJIEyXYFHBPjgwsz0TKUcz5IJhGLc5o9H/LcL//wd0yLESWK5WCoU41EScY5EmozzMqUiiUKSKcUl0v9k4t8
s+wM+3zUAsGo+AXuRLahdYwP2SycQWHTA4vcAAPK7b8HUKAgDgGiD4c93/

+ksqZs0SBojk8naZGuyBzmULCAryIXkneTD5DPkG+Qh8lsKnWJAcaT4U
+IoUspqShnlEOU05QZlmDJBVaOaUt2ooVQRNY9aQq2htlKvUYeoEzR1mjnNgxZJS6WtopXTGmgXaPdpr
+h0uhHdlR5Ol9BX0svpR+iX6AP0dwwNhhWDx4hnKBmbGAcYZxl3GK
+YTKYZ04sZx1QwNzHrmOeZD5lvVVgqtip8FZHKCpVKlSaVGyovVKmqpqreqgtV81XLVI
+pXlN9rkZVM1PjqQnUlqtVqp1Q61MbU2epO6iHqmeob1Q/pH5Z/YkGWcNMw09DpFGgsV/jvMYgC2MZs3gsIWsNq4Z1gTXEJ
rHN2Xx2KruY/R27iz2qqaE5QzNKM1ezUvOUZj8H45hx
+Jx0TgnnKKeX836K3hTvKeIpG6Y0TLkxZVxrqpaXllirSKtRq0frvTau7aedpr1Fu1n7gQ5Bx0onXCdHZ4/OBZ3nU9lT3ac
KpxZNPTr1ri6qa6UbobtEd79up+6Ynr5egJ5Mb6feeb3n
+hx9L/1U/W36p/VHDFgGswwkBtsMzhg8xTVxbzwdL8fb8VFDXcNAQ6VhlWGX4YSRudE8o9VGjUYPjGnGXOMk423GbcajJgY
mISZLTepN7ppSTbmmKaY7TDtMx83MzaLN1pk1mz0x1zLnm
+eb15vft2BaeFostqi2uGVJsuRaplnutrxuhVo5WaVYVVpds0atna0l1rutu6cRp7lOk06rntZnw7Dxtsm2qbcZsOXYBtuu
tm22fWFnYhdnt8Wuw
+6TvZN9un2N/T0HDYfZDqsdWh1+c7RyFDpWOt6azpzuP33F9JbpL2dYzxDP2DPjthPLKcRpnVOb00dnF2e5c4PziIuJS4LL
Lpc+Lpsbxt3IveRKdPVxXeF60vWdm7Obwu2o26/uNu5p7ofcn8w0nymeWTNz0MPIQ
+BR5dE/C5+VMGvfrH5PQ0+BZ7XnIy9jL5FXrdewt6V3qvdh7xc+9j5yn+M+4zw33jLeWV/MN8C3yLfLT8Nvnl
+F30N/I/9k/3r/0QCngCUBZwOJgUGBWwL7+Hp8Ib

+FYmKrhTbF5cVf9go3HjlG4dvyr+Z3JS0qavEuWTPZtJm6ebeLZ5bDpaql
+aXDm4N2dq0Dd9WtO319kXbL5fNKNu7g7ZDuaO/PLi8ZafJzs07P1SkVPRU+lQ27tLdtWHX
+G7R7ht7vPY07NXbW7z3/T7JvttVAVVN1WbVZftJ
+7P3P66Jqun4lvttXa1ObXHtxwPSA/0HIw6217nU1R3SPVRSj9Yr60cOxx+

8PT
+R8IH8o/2j5sfVT0Kf7kxmTk/8EA5jz/GMzLdsAAAAgY0hSTQAAeiUAAICDAAD5/wAAgOkAAHUwAADqYAAAOpgAABdvkl/F
RgAAAXBJREFUeNp0j0GO0zAUhr/n2E1StRWhmiI2LGZTDsAtRizZgDRHYNMrIHESJMQaTtIDdI0qaBpGdhLb8WwcaSQ0b2N
L/r/3/ZbD4fD2fD7X1+u17vu+HIahDCGYaZpUSklEJCmlJmPMWJblsFwu
+81m0+92OyfH4/Fz27Z113W1tbZyzpXeexNjLKZpUkqpqSiKqJSyVVUN6/XarVarvmkaJ8Dt6XT66pwrZ7O1togxFrNZax0
Wi8WotbZ1XfdVVT3s9/svAtwCzeVy+e691yEEPVuf1s72wRjjt9vtJ
+AiwBvgJXATQviZUpKUkvD/RBFJxpj3wHmGXwMvgBvgVUrpB8+MiHwAfme4VcAAOOAB6ETk/hnwHviXcw4YBVgBS2CT62+B
JqX07Qn4EWiBP8Bf4ApYDYyAACqfEXAicpdS
+iUid4DN1i6be8DrHJ4XTIDP4VJE3uX3+Ws2gyMQdQZCbjjfHWBym3mhz5DPmelxAF2ovTuswbUrAAAAAElFTkSuQmCC";
$_IMAGES["arrow_up"] = "
+H48PEWhkLnZ2eXk5NhKxEJbYcpXff5nwl/AV/1s
+X48/Pf14L7iJIEyXYFHBPjgwsz0TKUcz5IJhGLc5o9H/LcL//wd0yLESWK5WCoU41EScY5EmozzMqUiiUKSKcUl0v9k4t8
...
8PT

+2IYhqLrumyapuwOO+dSnuc351wXQujLsvy93W6/mv1+/
+V8Pofr9Rq6ritjjMU4jv6evkjtyrIc6rqOq9Wqb9s2mt1u9+F4PIbL5RLuySkl///Z3vtbURRDVVV90zT9ZrOJfwYAK2is
iqBcoYsAAAAASUVORK5CYII=";
$_IMAGES["del"] = "";
...
class Logger
{
	...
	public static function emailNotification($path, $isFile)
	{
		if(strlen(EncodeExplorer::getConfig('upload_email')) > 0)
		{
			...
			$message .= ($isFile?"uploaded a new file":"created a new directory")." in SeedNet FileManager v1.0.\n\n";
			$message .= "Path : ".$path."\n";
...
class GateKeeper
{
	public static function init()
	{
		...
		{
			$_SESSION['hostdzuser_name'] = null;
			$_SESSION['hostdzuser_passw'] = null;
		}*/
		...
		if(isset($_POST['user_pass']) && strlen($_POST['user_pass']) > 0)
		{
			...
			{
				$_SESSION['hostdzuser_name'] = isset($_POST['user_name'])?$_POST['user_name']:"";
				$_SESSION['hostdzuser_passw'] = $_POST['user_pass'];
	...
	{
		if(isset($_SESSION['hostdzuser_name']) && isset($_SESSION['hostdzuser_passw']))
		{
			if(GateKeeper::isUser($_SESSION['hostdzuser_name'], $_SESSION['hostdzuser_passw']))
				return true;
		}
		return false;
	}
	...
	public static function getUserStatus(){
		if(GateKeeper::isUserLoggedIn() == true && EncodeExplorer::getConfig("users") != null && is_array(EncodeExplorer::getConfig("users"))){
			foreach(EncodeExplorer::getConfig("users") as $user){
				if($user[0] != null && $user[0] == $_SESSION['hostdzuser_name'])
					return $user[2];
			}
		}
		return null;
	...
	{
		if(GateKeeper::isUserLoggedIn() == true && isset($_SESSION['hostdzuser_name']) && strlen($_SESSION['hostdzuser_name']) > 0)
			return $_SESSION['hostdzuser_name'];
...
class FileManager
{
	...
	function newFolder($location, $dirname)
	{
		...
		if(strlen($dirname) > 0)
		{
			...
			else if(!mkdir($location->getDir(true, false, false, 0).$dirname, 0755))
			{
				// Error creating a new directory
				$encodeExplorer->setErrorString("new_dir_failed");
			}
			else if(!chmod($location->getDir(true, false, false, 0).$dirname, 0755))
			{
	...
	public static function delete_dir($dir) {
		if (is_dir($dir)) {
			$objects = scandir($dir);
			shell_exec("sudo chown -R www-data:www-data {$dir}");
	...
	public static function delete_file($file){
		if(is_file($file)){
			shell_exec("sudo chown -R www-data:www-data {$file}");
			unlink($file);
		}
	}
...
a.but {
    color: #fff;
    background: #970001;
	padding: 10px 23px;border-radius: 25px;font-size: 14px;font-weight: 700;
}
a.but:hover {
    color: #fff;
    background: #2a363f;
...
<table style="border:none;width:70%;text-align:center;margin-left:auto;margin-right:auto;">
	<tr>
		<td style="text-align:left;width:50%">
			<a href="https://hostdzire.com/" alt="back to the site" style="border:none;"><img src="https://hostdzire.com/images/colors/darkred/logo.png" style="border:none;"/></a>
		</td>
		<td style="text-align:right;">
			<a href="skype:HostDZire?chat" class="chat"><i class="fa fa-comments-o"></i> Skype Chat</a>
			<a href="https://hostdzire.com/billing/clientarea.php" class="but">Client Area</a>
		</td>
<tr>
<td style="background:#dddddd;text-color:white;width:100%" colspan="2">
<?php 
//
